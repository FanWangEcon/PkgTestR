...
#' We can internally reference the sister function [ff_rtest_add_basic()]. Display
#' equation is shown with \deqn{x \cdot y}
#'
...
#' @return The product of \code{ar_fl_x} and \code{ar_fl_y} inline equation \eqn{x \cdot y}.
#' @export
#' @examples
